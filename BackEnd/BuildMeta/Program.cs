        ...
        static int Main(string[] args)
        {
            ...
            try
            {
                ...
                if (target.HasFlag(BuildTarget.Markdown))
                {
                    ...
                    var result = BuildMetaHelper.GenerateIndexForMarkdownListAsync(inputIndexFilePath, inputMarkdownList, outputMarkdownMapFileFolder, outputApiMapFileFolder, outputReferenceFolder).Result;
