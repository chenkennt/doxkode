        ...
        static int Main(string[] args)
        {
            ...
            try
            {
                ...
                if (target.HasFlag(BuildTarget.Markdown))
                {
                    ...
                    BuildMetaHelper.GenerateIndexForMarkdownListAsync(inputIndexFilePath, inputMarkdownList, outputMarkdownMapFileFolder, outputApiMapFileFolder, outputReferenceFolder).Wait();
                }
