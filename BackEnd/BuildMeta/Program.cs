        ...
        static int Main(string[] args)
        {
            ...
            try
            {
                var options = new Option[]
                    ...
                    new Option("root", s => inputRootFolder = s, defaultValue: DefaultOutputFolderName, helpName: "inputRootFolder", helpText: "Specify the Root folder for all the output files. (default: " + DefaultOutputFolderName + ")."),
                    ...
                    new Option("mdmap", s => outputMarkdownMapFileFolder = s, defaultValue: DefaultMarkdownIndexFolderName, helpName: "outputMarkdownMapFileFolder", helpText: "Specify the folder name containing all the markdown index. (default: " + DefaultMarkdownIndexFolderName + "). If not set, the index file will be generated in the same folder as the markdown file and when Markdown file is linking to API using YAML header, the API's index file will be generated in the same folder as the API yml file."),
                    new Option("apimap", s => outputApiMapFileFolder = s, defaultValue: DefaultMdFolderName, helpName: "outputApiMapFileFolder", helpText: "Specify the output subfolder name containing all the markdown files copied. (default: " + DefaultMdFolderName+ ")."),
                ...
                {
                    if (string.IsNullOrEmpty(inputProjectList))
                    {
                    ...
                    var result =
                        BuildMetaHelper.GenerateMetadataFromProjectListAsync(inputProjectList, intermediateOutputListFile).Result;
                ...
                {
                    var result = BuildMetaHelper.MergeMetadataFromMetadataListAsync(intermediateOutputListFile, outputFolder, outputIndexFile, outputTocFile, outputApiFolder, BuildMetaHelper.MetadataType.Yaml).Result;
